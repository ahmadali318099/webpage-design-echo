...
type SalesContactFormValues = z.infer<typeof formSchema>;
...
const SalesContactForm = () => {
  const form = useForm<SalesContactFormValues>({
  ...
  function onSubmit(data: SalesContactFormValues) {
    console.log('Sales Contact Submitted:', data);
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="tel" placeholder="Phone Number" {...field} className="bg-gh-gray-50 border-gh-gray-300"/>
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="email" placeholder="Business Email" {...field} className="bg-gh-gray-50 border-gh-gray-300"/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
